...
int main(int argc, char* argv[])
{
  ...
  start = clock();
  const char* filename1 = "./Optimizations/Long-W1.wav";
  const char* filename2 = "./Optimizations/Long-W2.wav";
  const char* filename3 = "./Optimizations/O-C-W3.wav";
  ...
  printf("execution time is %.2lf s.", cpu_time_used);
